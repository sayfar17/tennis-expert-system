...
class SkyForm(tk.Frame):
    def __init__(self, parent, respuestas, on_next):
        ...
        # Cabecera estilo App de Clima
        lbl_titulo = tk.Label(self, text="Condición del Cielo", font=("Segoe UI", 16, "bold"), bg="#0F172A",
                              fg="#F3E5F5")
        lbl_titulo.pack(pady=(35, 5))

        lbl_pregunta = tk.Label(self, text="Selecciona el estado del cielo para el partido:", font=("Segoe UI", 11),
                                bg="#0F172A", fg="#94A3B8")
        ...
        for opcion in self.opciones:
            # Asignar emoji dinámico de clima
            icono = "☀️" if opcion == "Soleado" else "☁️" if opcion == "Cubierto" else "🌧️"
        ...
        # Al ser el primer formulario, solo lleva el botón Siguiente
    ...
    def siguiente(self):
        if not self.opcion_seleccionada:
            ...
            return
        self.respuestas["Cielo"] = self.opcion_seleccionada
        self.on_next()