...
class TempForm(tk.Frame):
    def __init__(self, parent, respuestas, on_next):
        ...
        self.opciones = ["Caluroso", "Suave", "Fresco"]
        self.checkbox_vars = {}

        lbl_titulo = tk.Label(self, text="Seleccione Temperatura:", font=("Arial", 14, "bold"))
    ...
    def siguiente(self):
        ...
        if not seleccion:
            messagebox.showwarning("Advertencia", "Por favor seleccione una opción para Temperatura.")
            return
        
        self.respuestas["Temperatura"] = seleccion[0]
        self.on_next()
