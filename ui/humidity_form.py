...
class HumidityForm(tk.Frame):
    def __init__(self, parent, respuestas, on_next):
        ...
        lbl_titulo = tk.Label(self, text="Seleccione Humedad:", font=("Arial", 14, "bold"))
    ...
    def siguiente(self):
        ...
        if not seleccion:
            messagebox.showwarning("Advertencia", "Por favor seleccione una opción para Humedad.")
            return
        
        self.respuestas["Humedad"] = seleccion[0]
        self.on_next()
